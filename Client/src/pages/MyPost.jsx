      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mx-3 mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            A collection of your personal blog posts. Manage, edit, and share
            your thoughts with the world. Explore your creativity and let your
            voice be heard through your unique stories and insights.
          </p>
